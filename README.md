...
### HEAD  
Перейти в папку **.git**, вывести содержимое папки HEAD: **cd .git/, cat HEAD**  
Внутри HEAD - ссылка на служебный файл: *refs/heads/master* (или main в зависимости от названия ветки). В файле записан хеш последнего коммита  
Вывести содержимое файла: **cat refs/heads/master** _e007f5035f113f9abca78fe2149c593959da5eb7_  
